...
$marime="mari";
$pret="400";
$sql5="CALL procedura2('{$nume}','{$culoare}','{$marime}','{$pret}')";
$q=$con->query($sql5);
            ...
            <div class="container px-4 px-lg-5 d-flex h-100 align-items-center justify-content-center">
                <div class="d-flex justify-content-center">
                    <div class="text-center">
                        <h1 class="hero-title"> Data was succesfully inserted! <br/> <span class="highlight"><a href="Proc&Triggers.php">Back</a></span></h1>
                    </div>
                </div>
            </div>
        </header>
